...
exports.updateShipmentStatus = exports.getTrackingInfo = void 0;
const mock_shipments_data_1 = require("../data/mock-shipments.data");
/**
 * @swagger
...
const getTrackingInfo = (req, res) => {
    ...
    const shipment = mock_shipments_data_1.mockShipments.find(s => s.orderId === orderId);
    if (!shipment) {
